...
import styles from "./SimilarPropertiesContainer.module.css";

export type SimilarPropertiesContainerType = {
  className?: string;
};

const SimilarPropertiesContainer: FunctionComponent<
  SimilarPropertiesContainerType
> = ({ className = "" }) => {
  return (
    <section
      className={[styles.similarPropertiesContainer, className].join(" ")}
    >
      <div className={styles.similarPropertiesParent}>
        ...
        <div className={styles.similarPropertiesList}>
          <div className={styles.similarPropertyCards}>
            ...
            />
            <div className={styles.propertyCards1}>
              <img
